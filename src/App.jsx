   ...
   <ChakraProvider>
    ...
    >
     <Flex
      ...
      mb={8}
     >
      <Text my="6" fontSize="lg" fontWeight="600">
       {" "}
       This is a demo website to auto read OTP from SMS in the mobile browser.{" "}
      </Text>
      <Text my="1" color="green">
       {" "}
